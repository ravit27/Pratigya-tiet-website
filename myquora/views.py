...
def events(request):
    return render(request, 'myquora/events.html')


def team(request):
    return render(request, 'myquora/team.html')    
...
def contact(request):
    if request.method == 'POST':
        ...
        f = FeedbackForm()
    return render(request, 'myquora/contact.html', {'form': f})
...
def index(request):
    ...
    return render(request, 'myquora/index.html', context=context)
